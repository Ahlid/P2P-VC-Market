# JSON Web Token Plugin for Hapi.js - Terms and conditions

1. **Preamble:**
This Agreement governs the relationship between PicoSpark - Elecctro Solutions, Lda., a duly registered company in whose principal place of business is Urbanização do Valseá, Lote 11, 3280-053, Castanheira de Pêra, Portugal (hereinafter: Licensor) and its client, (hereinafter: Licensee). This Agreement sets the terms, rights, restrictions and obligations on using JSON Web Token Plugin for Hapi.js (hereinafter: The Software) created and owned by Licensor, as detailed herein
